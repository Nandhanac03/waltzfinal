...
class Solution_additional_info_model extends CO_Core_Model
{

    protected $tableName = 'solution_additional_info';
    ...
    public function get_by_solution_id($solution_id, $lang = '')
    {
        $where = "active = '1' AND solution_id = '$solution_id'";
        if ($lang) {
            $where .= " AND language = '$lang'";
        }
        // fetch multiple rows
        return $this->select("*", $where, $fetch_row = FALSE);
    }
}
