...
class Candidate extends CO_Panel_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Job_candidate_model', 'job_candidate_model');
    ...
    public function all()
    {
        ...
        $this->data['careers'] = $this->jobs_model->get_all_job_titles();
        $this->data['candidates'] = $this->candidate_model->get_all($filter);
        $this->data['applied_candidates'] = $this->job_candidate_model->get_all_panel($filter);
        // echo"<pre>";print_r($this->data['applied_candidates']);exit;
