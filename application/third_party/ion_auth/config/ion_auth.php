 ...
 */
$config['site_title']                 = config_item('WEBSITE_TITLE');// Site Title, example.com
$config['admin_email']                = config_item('PANEL_EMAIL'); // Admin Email, admin@example.com
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'mail_template/';
 ...
 */
$config['email_activate'] = 'activate/index.php';
 ...
 */
$config['email_forgot_password'] = 'forgot_password/index.php';
