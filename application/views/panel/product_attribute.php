                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php if ($controller_config['disable_add_attribute'] !== TRUE): ?>
                                <a href="<?= site_url('panel/product_attribute/add') ?>"
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="<?= site_url('panel/product_attribute/all') ?>"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>											
                                                <?php if ($attribute_items): ?>
                                                    <?= $attribute_items ?><?php else: ?>
                                                    <tr>
