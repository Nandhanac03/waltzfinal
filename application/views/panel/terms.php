                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php if ($controller_config['disable_news_add'] != TRUE): ?>
                                <a href="<?= site_url('panel/terms/add') ?>" class="btn btn-sm btn-info float-right"
                                ...
                                <tbody>
                                    ...
                                    if ($terms): $i = 0;
                                        foreach ($terms as $term): $i++;
                                            ...
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td><?= htmlspecialchars($term->title, ENT_QUOTES, 'UTF-8'); ?></td>
                                                
                                                <td><?= htmlspecialchars(date('d-m-Y H:i', $term->created_at), ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td>
                                                    <a href="<?= site_url('panel/terms/edit/' . $term->id) ?>"
