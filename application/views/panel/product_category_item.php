<tr>
    ...
    <td>
        <a href="<?= site_url('panel/product_category/edit/' . $category_id) ?>" title='Edit' class="btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
        <a href="#" class="btn-sm btn-danger trigger_alert_modal" data-title="Confirm" data-desc="Are you sure want to delete this? <p class='text-danger'><i>(If you confirm, the item will be permanently removed from the server. The process cannot be reverted.)</i></p>" data-redirect="<?= site_url('panel/product_category/delete_category/' . $category_id) ?>" title='Delete'><i class="fas fa-trash-alt"></i></a>
    </td>
</tr>