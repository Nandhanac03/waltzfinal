            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('panel/product_category/all') ?>">Category</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card card-dark">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="<?= site_url('panel/product_category/edit/' . $id . '/' . $current_language->id) ?>" enctype="multipart/form-data" id="categoryForm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php if ($languages && count($languages) > 1 && $controller_config['disable_languages_category'] != TRUE) : ?>
                                            <ul class="nav nav-tabs mb-4" id="news-content-below-tab" role="tablist">
                                                ...
                                                ?>
                                                    <li class="nav-item">
                                                        <a class="nav-link <?= in_array($language->id, $category_languages) && $language->id != $current_language->id ? ' bg-navy' : '' ?><?= $language->id == $current_language->id ? ' active bg-success' : '' ?>" href="<?= base_url('panel/product_category/edit/' . $id . '/' . $language->id) ?>" role="tab" aria-selected="true"><?= $language->name ?></a>
                                                    </li>
                                                <?php
                                                endforeach;
                                                ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($controller_config['disable_product_category_seo'] !== TRUE) : ?>
                                        <div class="form-group col-sm-12">
                                            <div class="card">
                                                <div class="card-header">
