            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card card-dark">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="<?= site_url('panel/why/add') ?>" enctype="multipart/form-data" id="jobsForm">
                            <div class="card-body">
                                <?= $alert ?>
                                <div class="row">
                                    ...
                                    <?php if ($controller_config['disable_short_description'] != TRUE) : ?>
                                        <div class="form-group col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="shortDesc" placeholder="Value" name="shortDesc" value="<?= set_value('shortDesc') ?>">
