                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= site_url('panel/mailer/Compose') ?>" class="btn btn-sm btn-info float-right"
                               title="Add"><i class="fas fa-plus"></i> Compose</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="post" action="<?= site_url('panel/mailer/sent') ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn-sm btn-danger trigger_alert_modal"
                                                       ...
                                                       data-redirect="<?= site_url('panel/mailer/delete/' . $mail_content->id) ?>"
