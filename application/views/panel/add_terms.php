            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('panel/faq/all') ?>">Terms of Service</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card card-dark">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="<?= site_url('panel/terms/add') ?>" enctype="multipart/form-data" id="jobsForm">
                            <div class="card-body">
                                <div class="row">
