                ...
                <div class="col-6 offset-md-3">
                    ...
                    <div class="card card-dark">
                        ...
                        <form role="form" method="post"
                              action="<?= site_url('panel/user/edit_permission/' . $permission->id) ?>">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="regPermissionKey"
                                           ...
                                           value="<?= set_value('regPermissionKey', $permission->perm_key) ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="regPermissionName"
                                           ...
                                           value="<?= set_value('regPermissionName', $permission->perm_name) ?>">
