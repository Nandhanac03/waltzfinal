            ...
            <div class="row">
                <div class="col-6 offset-md-3">
                    ...
                    <div class="card card-dark">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="<?= site_url('panel/user/edit_group/' . $group->id) ?>">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="regGroupName">Group Name</label>
                                    <input type="text" class="form-control" id="regGroupName" placeholder="Group name"
                                           name="regGroupName" value="<?= set_value('regGroupName', $group->name) ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" class="form-control" id="regGroupDesc" placeholder="Group Desc"
                                              name="regGroupDesc"><?= set_value('regGroupDesc', $group->description) ?></textarea>
