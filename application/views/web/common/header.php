<div class="page-wrapper" id="page">
	...
	<header class="site-header pbmit-header-style-2" id="masthead">
		<div class="pbmit-header-overlay clearHeader innerhead">
			<div class="pbmit-main-header-area">
				<div class="pbmit-header-content">
					<div class="container-fluid">
						<div
							class="pbmit-header-content d-flex align-items-center justify-content-between">
							<div class="pbmit-header-menu-area d-flex align-items-center newhome">
								...
								<div
									...
									<div class="site-navigation">
										<nav class="main-menu pbmit-navbar innerdata">
											<div>
