	...
	<div class="pbmit-title-bar-wrapper"
		style="background-image: url('<?= base_url('assets/web/images/contact_banner.jpg') ?>') !important;">
	...
	<div class="page-content contact-us">
		...
		<section class="ihbox-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-xl-3 pbmit-column mb-xl-0 mb-4">
						<div class="pbmit-ihbox-style-3">
							<div class="pbmit-ihbox-box">
								...
								<div class="pbmit-ihbox-contents">
									...
									<a href="mailto:<?= $common_contact->email ?>">
										<div class="pbmit-heading-desc"><?= $common_contact->email ?>
										</div>
									</a>
								</div>
							</div>
					...
					<div class="col-md-12 col-xl-5 pbmit-column mb-xl-0 mb-4">
						<div class="pbmit-ihbox-style-3">
							<div class="pbmit-ihbox-box">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
								...
								<div class="pbmit-ihbox-contents">
									...
									<div class="pbmit-heading-desc"><?= $common_contact->address ?></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="pbmit-ihbox-style-3">
							<div class="pbmit-ihbox-box">
								...
								<div class="pbmit-ihbox-contents">
									...
									<a href="tel:<?= $common_contact->phone ?>">
										<div class="pbmit-heading-desc"><?= $common_contact->phone ?>
										</div>
									</a>
								</div>
							</div>
		...
		<!-- Contact Form -->
		<section class="mb-5" id="contact-form-section">
			<div class="container">
				<div class="pbmit-heading-subheading text-center">
					<h2 class="pbmit-title"><?= $workingtgr->title ?>.</h2>
				</div>
				<div class="row g-0">
										...
										<div class="pbmit-ihbox-contents">
											...
											<h2 class="pbmit-element-title">
												<a class="pbmit-button-inner" href="#">
													<span class="pbmit-button-icon">Explore</span>
												</a>
											</h2>
										</div>
									</div>
					...
					<div class="col-md-12 col-xl-8 contact-form-right-col">
						<div class="contact-form-right-box pbmit-bg-color-white">
							<div class="pbmit-custom-heading">
								<h2 class="pbmit-title"><?= $sendmsg->title ?></h2>
							</div>
							...
							<form class="contact-form" method="post" id="contact-form">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<input type="email" name="contact_email" id="contact_email" class="form-control" placeholder="Your Email" required>
									</div>
									<div class="col-md-6">
										<input type="tel" name="contact_phone" id="contact_phone" class="form-control" placeholder="Your Phone" required>
									</div>
									<div class="col-md-6">
										<input type="text" name="contact_subject" id="contact_subject" class="form-control" placeholder="Subject" required>
									</div>
									<div class="col-md-12">
										<textarea name="contact_message" id="contact_message" class="form-control" placeholder="Your Message" rows="10" required></textarea>
									</div>
									<div class="col-md-12 pbmit-button-wrapper">
										<button type="button" class="pbmit-btn submit" id="formSendBtn">
											<span class="pbmit-button-text">Send</span>
							...
							<div id="response" class="col-md-12 mt-3"></div>
		...
		<script>
			$(document).ready(function() {
				...
				grecaptcha.ready(function() {
					grecaptcha.execute("<?= config_item('SITE_KEY'); ?>", {
						action: "contact"
					}).then(function(token) {
				...
				$("#formSendBtn").click(function(e) {
					...
					if (!formData.contact_subject) {
						...
						$('#contact_subject').addClass('is-valid');
					}
					...
					if (!formData.contact_message) {
						...
						$('#contact_message').addClass('is-valid');
					}

					// Proceed with AJAX if valid
					if (isValid) {
						// Show loader
						$('.pbmit-btn.submit .form-btn-loader').removeClass('d-none');
						$('.pbmit-btn.submit .pbmit-button-text').text('Sending...');

						$.ajax({
							url: "<?= base_url('contact_us/send'); ?>",
							type: "POST",
							data: formData,
							dataType: "json",
							success: function(response) {
								// Hide loader
								$('.pbmit-btn.submit .form-btn-loader').addClass('d-none');
								$('.pbmit-btn.submit .pbmit-button-text').text('Send');
								...
								if (response.status === "success") {
									...
									$('#contact-form .form-control').removeClass('is-valid is-invalid');

									// OR hide validation borders completely:
									// $('#contact-form .form-control').removeClass('is-valid is-invalid').addClass('d-none');
