...
// Append navigation buttons inside the current slider
if (carouselElement.data("arrows") === true) {
    carouselElement.append('<div class="swiper-button-next swiper-button-next-' + x + '"></div>');
    carouselElement.append('<div class="swiper-button-prev swiper-button-prev-' + x + '"></div>');
}

// Navigation setup scoped to this slider
var navigation_val = {
    nextEl: ".pbmit-element-viewtype-carousel-" + x + " .swiper-button-next-" + x,
    prevEl: ".pbmit-element-viewtype-carousel-" + x + " .swiper-button-prev-" + x,
};
